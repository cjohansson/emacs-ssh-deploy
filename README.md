...
```
* Now when you save a file somewhere under the root `/Users/username/Web/MySite/`, the script will launch and deploy the file with the remote server. You can also trigger a manual deploy by pressing `C-c C-z u`.
